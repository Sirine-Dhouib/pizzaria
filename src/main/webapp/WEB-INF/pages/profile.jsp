			...
			<div class="col-lg-8 offset-lg-2 text-center">
				<div class="breadcrumb-text">
					<p>Bienvenue sur votre profil, vous pouvez suivre l'etat de vos
						commandes</p>
					<h1>Cher client, ${userLogin.getPrenom()}</h1>
					<c:if test="${not empty sessionScope.commandePasser}">
                        <h6 class="text-success">La ${commandePasser} est passeée avec succes</h6>
						...
						<div class="card-body p-4">
							...
							<div class="d-flex justify-content-between pt-2">
								...
								<p class="text-muted mb-0">
									<span class="fw-bold me-4">Total</span> ${commande.total} TND
								</p>
							</div>
								...
								<div class="card shadow-0 border mb-4">
									<div class="card-body">
										<div class="row">
											...
											<div
												class="col-md-2 text-center d-flex justify-content-center align-items-center">
												<p class="text-muted mb-0 small">${pizza.prix}TND</p>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="card-header px-4 py-5">
					<h5 class="text-muted mb-0">
						Votre historique, <span style="color: #a8729a;"> Cher
							client, ${userLogin.getPrenom()}</span>!
					</h5>
				</div>
